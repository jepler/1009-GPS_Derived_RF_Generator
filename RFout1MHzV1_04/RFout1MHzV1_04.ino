...
//The NEO-6 has an internal 48MHz PLL that can be diveded down to any freq below 10MHz. Divide to a frequency that is an integer fraction of 48MHz to get 
//the lowest jitter
//Examples on low jitter freqencies is 1, 2, 4 and 8 MHz  
...
#include <NMEAGPS.h>  //NeoGps by SlashDEvin https://github.com/SlashDevin/NeoGPS
#include <SoftwareSerial.h>  // SoftwareSerial by Arduino 
...
boolean GPSOK;
const char softwareversion[] = "1.04" ; //Version of this program, sent to serialport at startup
